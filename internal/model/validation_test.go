...
func TestResourceValidation(t *testing.T) {
	tests := []struct {
		...
		{"subnet", &Subnet{NetworkID: "n", Name: "v4", CIDR: "10.0.0.0/24", GatewayIP: "10.0.0.1", DNSNameservers: []string{"1.1.1.1"}, AllocationPools: []IPRange{{Start: "10.0.0.10", End: "10.0.0.20"}}}, true},
