...
func TestResourceValidation(t *testing.T) {
	tests := []struct {
		...
		{"subnet implicit gateway", &Subnet{ProjectID: "p", NetworkID: "n", Name: "implicit", CIDR: "10.0.1.0/24"}, true},
		{"subnet too narrow", &Subnet{ProjectID: "p", NetworkID: "n", Name: "narrow", CIDR: "10.0.2.0/31"}, false},
		{"subnet gateway is network", &Subnet{ProjectID: "p", NetworkID: "n", Name: "network-gateway", CIDR: "10.0.3.0/24", GatewayIP: "10.0.3.0"}, false},
